        ...
        <div className="tools">
          <div className='chose-tool'>
            <ul>
                ...
                <li><a onClick={gptFunct} data-index="2" className='one-tool' href="#">Generate video description<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>text</title><path d="M21,6V8H3V6H21M3,18H12V16H3V18M3,13H21V11H3V13Z" /></svg></a></li>
